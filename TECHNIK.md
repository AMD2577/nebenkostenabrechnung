# Technik · Nebenkostenabrechnung 2025

Wie die Lösung bedient wird, wie sie aufgebaut ist und woran man erkennt, dass die Zahlen stimmen.
Das Ergebnis und die Befunde stehen im [README](README.md).
...
Ohne Kommandozeile (macOS): `Bauen.command`, `Pruefen.command`, `Zuruecksetzen.command` per
Doppelklick.

---

## 1 Die Oberfläche bedienen

`dist/Nebenkostenabrechnung_2025.html` öffnen. Die Reiter folgen dem Arbeitsablauf:
...
- **Belege** — alle 23 Belege mit Positionen und Umlagefähigkeit; hier wird auch eine neue Rechnung
  eingelesen (siehe Abschnitt 3) oder ein Beleg entfernt.
- **Konto** — die Monatssalden und Buchungen des Objektkontos; hier lässt sich eine Zahlung
  nachtragen, die nicht über das Konto lief.
...
Falldatei — siehe Abschnitt 3.

---

## 2 Wie es aufgebaut ist
...
## 3 Neue Belege erfassen

### Der einfache Weg: PDF hineinziehen

Reiter *Belege* → PDF in das Feld ziehen. Die Lösung liest den Text aus dem PDF und macht
...
Ohne PDF: im selben Bereich „Text einfügen" aufklappen und den Text der Rechnung hineinkopieren —
...
In den Reitern **Belege** und **Konto**:
...
- **Beleg entfernen** — Knopf neben dem Betrag. Der Grund wird abgefragt und landet im Protokoll,
  ...
  heißt: alten entfernen, neuen im selben Reiter einlesen.
...
## 4 Wenn sich die Unterlagen ändern
...
|---|---|---|
| **GEÄNDERT** | Das PDF wurde ausgetauscht oder bearbeitet | Dokument in der Oberfläche unter *Belege* neu einlesen und mit der erfassten Fassung vergleichen |
...
3. die Belege und Buchungen des neuen Jahres erfassen (Oberfläche, Reiter *Belege*)
...
## 6 Woran man erkennt, dass die Zahlen stimmen
